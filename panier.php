...
if(isset($_POST['submit'])){
  ...
  //echo "<br>Nombre de produits : ". $nbProduits;

  //on affiche le contenu du panier 
  // $contenu_panier = $Panier->getList();
...
// on modifie la quantité du premier produit
  ...
  // $Panier->updateQteProduits(1,35);

//on re-affiche le nombre de produits dans le pannier
  // $nbProduits = $Panier->getNbProduitAuPanier();
  // echo "<br>Nombre de produits : ". $nbProduits;
...
//on re-affiche le montant total du panier
  // $total = $Panier->getPrixTotalePanier();
  // echo "<br>Total panier : ". $total ;


// On retire le produit dont l'id est : 654
  // echo "<br><hr><br>On retire le produit dont l'id est : " ;
  // removeProduct(3);
//if (!) {
  # code...
//}
